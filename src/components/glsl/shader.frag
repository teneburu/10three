...
#else
    // Optimize for resize.
    #define res (iResolution.xy/4.0) // Reduced division factor for higher resolution
#endif

// Hardness of scanline.
//  -8.0 = soft
// -16.0 = medium
float hardScan=-13.0; // Increased for sharper scanlines

// Hardness of pixels in scanline.
// -2.0 = soft
// -4.0 = hard
float hardPix=-4.0; // Increased for sharper pixels
